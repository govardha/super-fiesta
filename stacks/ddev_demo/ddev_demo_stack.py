...
class DdevDemoStack(Stack):
    ...
    def create_ddev_instance(self):
        ...
        user_data_script.add_commands(
            ...
            "echo 'Registering with target group...'",
            ...
            f'    /usr/local/bin/aws elbv2 register-targets --target-group-arn {self.guacamole_tg.target_group_arn} --targets Id=$INSTANCE_ID,Port=8080 --region {self.region} || true',
            "fi",
            "",
